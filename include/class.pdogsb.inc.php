...
/**
 * Retourne les informations d'un utilsateur
 * @param $login
 * @param $mdp
 * @return l'id, le nom et le prénom sous la forme d'un tableau associatif
*/
	public function getInfosUtilisateur($login, $mdp){
		$req = "select id, type, nom, prenom from utilisateurs
...
*/
	public function getLesVisiteurs(){
		$req = "select id, type, nom, prenom from utilisateurs
		where type='visiteur' order by utilisateurs.nom";
		$rs = PdoGsb::$monPdo->query($req);
		$ligne = $rs->fetchAll();
		return $ligne;
	}
...
/**
 * Retourne la liste des visiteurs à rembourser
 * @return l'id, le nom et le prénom sous la forme d'un tableau associatif
*/
	public function getLesVisiteursARembourser(){
		$req = "select distinct utilisateurs.id as id, utilisateurs.nom as nom, utilisateurs.prenom as prenom from utilisateurs
		inner join fichefrais on utilisateurs.id = fichefrais.idVisiteur
		where utilisateurs.type='visiteur' and fichefrais.idEtat='VA'
...
/**
 * Reporte un frais hors forfait pour un visiteur et un mois donné
 * à partir des informations fournies en paramètre
 * @param $idFrais
 * @param $idVisiteur
 * @param $mois
*/
	public function reporterFrais($idFrais, $idVisiteur, $mois) {
...
/**
 * Retourne les mois pour lesquel un visiteur a une fiche de frais validée à rembourser
 * @param $idVisiteur
 * @return un tableau associatif de clé un mois -aaaamm- et de valeurs l'année et le mois correspondant
*/
	public function getLesMoisDisponiblesARembourser($idVisiteur){
		$req = "select mois as mois from fichefrais where idvisiteur ='$idVisiteur' and idEtat = 'VA'
		order by mois desc ";
		$res = PdoGsb::$monPdo->query($req);
		$lesMois =array();
		$laLigne = $res->fetch();
