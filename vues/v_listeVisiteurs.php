                <div class="page-header">
                    <h1>Validation des fiches de frais de :</h1>
                </div>
                <div class="row">
                    <form method="POST" action="index.php?uc=validerFrais&action=voirEtatFiche" form="form-inline">
                        <fieldset>
                            <div class="form-group col-md-6">
                                <div class="input-group">
                                    <span class="input-group-addon  input-group-addon-small"><i class="fa fa-users"></i></span>
                                    <select id="lstVisiteur" name="lstVisiteur" aria-describedby="sizing-addon1" class="form-control" onchange="this.form.submit()">
